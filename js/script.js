...
var chat = {
    ...
    init: function() {
        ...
        $('#email').defaultText('Email (emails are Enabled)');
        ...
        $('#loginForm').submit(function() {
            ...
            // Using our tzPOST wrapper
            // function(defined in the bottom):
    ...
    render: function(template, params) {
        ...
        switch (template) {
            ...
            case 'chatLine':
                arr = [
                    '<div class="chat chat-', params.id, ' rounded"><span class="email"><img src="', params.email,
